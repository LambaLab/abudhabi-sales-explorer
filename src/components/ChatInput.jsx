...
export function ChatInput({ onSubmit, onStop, isLoading, settings, onSettingsChange }) {
  ...
  return (
    <form
      ...
      className="relative flex items-end rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800/60 shadow-sm focus-within:border-accent focus-within:ring-2 focus-within:ring-accent/20 transition-colors"
    >
