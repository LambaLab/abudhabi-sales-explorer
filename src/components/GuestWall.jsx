/**
 * GuestWall — renders a sign-in modal overlay when a guest has seen 3+ posts.
 * Props: user (null = guest), postsCount, onSignIn
 */
    ...
    >
      <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl p-8 max-w-sm w-full text-center space-y-4">
        ...
        <p className="text-sm text-slate-500 dark:text-slate-400">
          Join to see all posts and start exploring Abu Dhabi real-estate data.
        </p>
        <button
          onClick={onSignIn}
